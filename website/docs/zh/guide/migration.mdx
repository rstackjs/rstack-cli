...
- **应用构建：**将 [webpack](https://rsbuild.rs/zh/guide/migration/webpack)、[Vite](https://rsbuild.rs/zh/guide/migration/vite)、[Create React App](https://rsbuild.rs/zh/guide/migration/cra) 或 [Vue CLI](https://rsbuild.rs/zh/guide/migration/vue-cli) 项目迁移到 Rsbuild。
- **库构建：**将使用 [tsup](https://rslib.rs/zh/guide/migration/tsup) 或 [tsc](https://rslib.rs/zh/guide/migration/tsc) 构建的库迁移到 Rslib。
- **测试：**将 [Jest](https://rstest.rs/zh/guide/migration/jest) 或 [Vitest](https://rstest.rs/zh/guide/migration/vitest) 项目迁移到 Rstest。
