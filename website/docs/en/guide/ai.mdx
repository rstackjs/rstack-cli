...
The evidence runtime is implemented by the separate `@rstackjs/context` package and is also
available through `rstack/context`. The plugin repository contains the launcher and workflows, not
a second copy of that runtime.
